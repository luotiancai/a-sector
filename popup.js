...
【企业行为判断规则——遇到具体公司新闻必须先用这套规则】
利好(bullish)：成立新公司/子公司、重大合同中标、新产品获批、高管增持、股份回购、业绩大幅超预期
利空(bearish)：被监管处罚/立案调查、重大诉讼败诉、高管大幅减持、业绩大幅低于预期、定增摊薄
中性(neutral)：高管正常变动、例行公告、小额日常合同

遇到具体公司名时，根据主营业务推断板块（如：国投电力→电力；宁德时代→电池；中芯国际→半导体）

【宏观/行业事件判断规则】
利好：降准降息、产业扶持政策、行业供给收缩（矿难/事故）、重大订单/合作
利空：监管收紧、加征关税/制裁、供应过剩、需求骤降
保留但中性：方向不明但值得关注的政策变化

【过滤 skip=true】
- 境外无关社会事件（他国事故/犯罪/选举等与A股无传导路径的）
- 纯境外小市场行情播报
- 完全无法推断A股影响的模糊信息
...
[{"i":0,"skip":false,"s":"bullish","tags":["电力"],"r":"扩张新业务"},...]
s: bullish/bearish/neutral
skip=true 时 s/tags/r 填空字符串
